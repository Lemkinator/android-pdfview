        ...
        project.extensions.configure<PublishingExtension>("publishing") {
            publications {
                create<MavenPublication>("mavenJava") {
                    ...
                    pom {
                        name = artifact
                        url = "https://github.com/Lemkinator/android-pdfview"
                        developers {
                            developer {
                                id = "Lemkinator"
                                name = "Leonard Lemke"
                        ...
                        scm {
                            connection = "scm:git:git://github.com/Lemkinator/android-pdfview.git"
                            developerConnection = "scm:git:ssh://github.com/Lemkinator/android-pdfview.git"
                            url = "https://github.com/Lemkinator/android-pdfview"
                        }
                        issueManagement{
                            system = "GitHub Issues"
                            url = "https://github.com/Lemkinator/android-pdfview/issues"
                        }
                        licenses {
                            license {
                                name = "Apache-2.0"
            ...
            repositories {
                maven {
                    name = "GitHubPackages"
                    url = uri("https://maven.pkg.github.com/lemkinator/android-pdfview")
                    credentials {
